...
import { Mail, MapPin, Github, Linkedin, Twitter, Send, Terminal } from "lucide-react";
            ...
            <Card className="bg-card/50 backdrop-blur border-primary/20 hover-glow">
              <div className="terminal-window">
                <div className="terminal-header">
                  ...
                  <span className="font-mono text-xs text-muted-foreground ml-2">~/contact.js</span>
                </div>
                <CardContent className="p-6">
                  <div className="font-mono text-sm space-y-4">
                    <div className="text-primary">const contactInfo = {'{'}</div>
                    ...
                    <div className="ml-4 space-y-2">
                      ...
                      <div className="flex items-center gap-3 text-muted-foreground">
                        ...
                        location: <span className="text-foreground">"{contact.location}"</span>,
                      </div>
                      <div className="text-muted-foreground">
                        availability: <span className="text-green-400">"open_to_opportunities"</span>
                      </div>
                    </div>
                    ...
                    return (
                      <div key={index} className="flex items-center justify-between p-3 bg-muted/30 rounded-lg hover:bg-muted/50 transition-colors">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="font-mono text-sm text-foreground">{social.name}</span>
                          <span className="font-mono text-xs text-muted-foreground">{social.handle}</span>
                        </div>
                        <Button
                          variant="outline"
                          size="sm"
          ...
          <Card className="bg-card/50 backdrop-blur border-primary/20 hover-glow">
            <div className="terminal-window">
              <div className="terminal-header">
                ...
                <div className="terminal-dot yellow"></div>
                <div className="terminal-dot green"></div>
                <span className="font-mono text-xs text-muted-foreground ml-2">~/send_message.js</span>
              </div>
              ...
              <CardContent className="p-6">
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-2">
                    <label className="font-mono text-sm text-primary">const name =</label>
                    <Input
                      name="name"
                  ...
                  <div className="space-y-2">
                    <label className="font-mono text-sm text-primary">const email =</label>
                    <Input
                      name="email"
                      type="email"
                  ...
                  <div className="space-y-2">
                    <label className="font-mono text-sm text-primary">const message =</label>
                    <Textarea
                      name="message"
                ...
                <div className="mt-6 p-4 bg-muted/30 rounded-lg">
                  <div className="font-mono text-xs text-muted-foreground space-y-1">
                    ...
                    <div className="text-primary">// Preferred topics</div>
                    <div>Backend architecture, API design, blockchain projects</div>
                  </div>
                </div>
              </CardContent>
            </div>
